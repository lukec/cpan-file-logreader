# This Makefile is for the File::LogReader extension to perl.
#
...
#     LICENSE_FROM => q[lib/File/LogReader.pm]
#     NAME => q[File::LogReader]
#     VERSION_FROM => q[lib/File/LogReader.pm]
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/File/LogReader.pm
...
TO_INST_PM = lib/File/LogReader.pm

PM_TO_BLIB = lib/File/LogReader.pm \
...
DISTNAME = File-LogReader
DISTVNAME = File-LogReader-0.01
...
manifypods : pure_all  \
	lib/File/LogReader.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/File/LogReader.pm $(INST_MAN3DIR)/File::LogReader.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:                File-LogReader' >> META_new.yml
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' -- \
	  lib/File/LogReader.pm blib/lib/File/LogReader.pm 
